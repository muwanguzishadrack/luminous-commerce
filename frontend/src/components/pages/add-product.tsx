  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      ...
      <div className="space-y-2">
        ...
        <h2 className="text-xl font-medium tracking-tight text-gray-900">Add New Product</h2>
      </div>
      ...
      <div className="grid gap-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <Button variant="outline" onClick={clearFields} className="w-full rounded-xl">
            Clear Fields
          </Button>
          <Button
