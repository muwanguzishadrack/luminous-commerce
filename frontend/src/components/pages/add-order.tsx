  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      ...
      <div className="space-y-2">
        ...
        <h2 className="text-xl font-medium tracking-tight text-gray-900">Add New Order</h2>
      </div>
      ...
      <div className="grid gap-6">
        ...
        {/* Action Buttons */}
        <div className="flex gap-3">
          <Button variant="outline" onClick={clearFields} className="flex-1 rounded-xl" size="sm">
            Clear Fields
          </Button>
          <Button
